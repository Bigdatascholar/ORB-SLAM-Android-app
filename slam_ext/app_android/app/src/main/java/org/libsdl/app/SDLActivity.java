...
import com.viewtwoo.CustomJavaCameraView;
import com.viewtwoo.R;
...
public class SDLActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout.LayoutParams rp = new RelativeLayout.LayoutParams(displaySize.x, displaySize.y);
        ...
        rp.addRule(RelativeLayout.VISIBLE, RelativeLayout.TRUE);

        mSurface.setLayoutParams(rp);
        mLayout.addView(mSurface);

        CustomJavaCameraView preview = new CustomJavaCameraView(this, -1);
        preview.setId(R.id.cameraSurface);
        preview.setLayoutParams(rp);
        //preview.setFixedFocus();
